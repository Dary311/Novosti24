...
class MainActivity : AppCompatActivity(), NewsItemClicked {
    ...
    //Делает запрос к API новостей и обрабатывает полученные данные.
    private fun fetchData() {

        val url = "https://newsapi.org/v2/top-headlines?country=us&apiKey=f0854a024c71431ba3e424141ebf7ba5"
